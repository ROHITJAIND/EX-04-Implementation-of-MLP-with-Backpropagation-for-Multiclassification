...
### Aim: &emsp;
To implement a Multilayer Perceptron for Multi classification &emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;**DATE:25.04.2024**
### Theory:
...
### Program:
```Python
import pandas as pd								#Developed By: ROHIT JAIN D
import sklearn									#Register No : 212222230120
...
```
### Output:
![image](https://github.com/ROHITJAIND/EX-04-Implementation-of-MLP-with-Backpropagation-for-Multiclassification/assets/118707073/45b81160-7198-49e2-907c-ef8e8eb30957)
### Program:
```Python
import pandas as pd
from sklearn.model_selection import train_test_split
